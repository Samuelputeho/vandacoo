...
class ProfileCommentBottomSheet extends StatefulWidget {
  final String postId;
  final String userId;
  final String posterUserName;

  const ProfileCommentBottomSheet({
    super.key,
  ...
  @override
  State<ProfileCommentBottomSheet> createState() =>
      _ProfileCommentBottomSheetState();
}
