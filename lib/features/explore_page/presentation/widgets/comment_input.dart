...
class _CommentInputState extends State<CommentInput> {
  ...
  void _submitComment() {
    if (_commentController.text.isNotEmpty) {
      if (_commentController.text.length > CommentInput.maxCommentLength) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
                'Comment cannot exceed ${CommentInput.maxCommentLength} characters'),
          ...
          children: [
            Expanded(
              child: TextField(
                ...
                maxLength: CommentInput.maxCommentLength,
                maxLines: null,
