...
//funcions for the comments
  Future<UserModel> getCurrentUserInformation(String userId);
...
//functions for the posts
  ...
  Future<List<String>> getViewedStories(String viewerId);
...
class PostRemoteDataSourceImpl implements PostRemoteDataSource {
  ...
  Future<MessageModel> sendMessage({
    ...
    try {
      ...
      if (mediaFile != null) {
        ...
        // Get the public URL
        finalMediaUrl = supabaseClient.storage
            .from(AppConstants.messageMediaTable)
  ...
  @override
  Future<UserModel> getCurrentUserInformation(String userId) async {
    try {
  ...
  @override
  Future<List<String>> getViewedStories(String viewerId) async {
    try {
      final response = await supabaseClient
