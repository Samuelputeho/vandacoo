...
class SavedPostCommentBottomSheet extends StatefulWidget {
  final String postId;
  final String userId;
  final String posterUserName;
  const SavedPostCommentBottomSheet({
    super.key,
  ...
  @override
  State<SavedPostCommentBottomSheet> createState() =>
      _SavedPostCommentBottomSheetState();
}

class _SavedPostCommentBottomSheetState
    extends State<SavedPostCommentBottomSheet> {
