...
import '../pages/service/feeds_export_services.dart';

class FeedsTrimmerView extends StatefulWidget {
  final File videoFile;
  final Duration maxDuration;

  const FeedsTrimmerView({
    super.key,
  ...
  @override
  FeedsTrimmerViewState createState() => FeedsTrimmerViewState();
}

class FeedsTrimmerViewState extends State<FeedsTrimmerView> {
  ...
  Future<void> _exportVideo() async {
    ...
    try {
      await FeedsExportService.trimVideo(
