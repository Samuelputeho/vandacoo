...
class PostModel extends PostEntity {
  ...
  Map<String, dynamic> toJson() {
    return <String, dynamic>{
      ...
      'user': user?.toJson(),
      'is_from_followed': isFromFollowed,
  ...
  factory PostModel.fromJson(Map<String, dynamic> map) {
    ...
    return PostModel(
      ...
      isFromFollowed: map['is_from_followed'] as bool? ?? false,
  ...
  PostModel copyWith({
    ...
    return PostModel(
      ...
      user: user ?? this.user,
      isFromFollowed: isFromFollowed ?? this.isFromFollowed,
