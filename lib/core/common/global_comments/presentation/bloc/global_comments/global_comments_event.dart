...
class GetAllGlobalPostsEvent extends GlobalCommentsEvent {
  final String userId;
  final bool isFeedsScreen;
  final String screenType; // 'feed', 'explore', 'following'

  const GetAllGlobalPostsEvent({
    required this.userId,
    this.isFeedsScreen = false,
    this.screenType = 'feed',
  });

  @override
  List<Object?> get props => [userId, isFeedsScreen, screenType];
}
...
class ClearGlobalPostsEvent extends GlobalCommentsEvent {}

class MarkStoryAsViewedEvent extends GlobalCommentsEvent {
  final String storyId;
  final String userId;

  const MarkStoryAsViewedEvent({
