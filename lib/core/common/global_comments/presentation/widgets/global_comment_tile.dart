...
class GlobalCommentsTile extends StatefulWidget {
  final CommentEntity comment;
  final String currentUserId;
  final String Function(DateTime) formatTimeAgo;
  final Function(String, String) onDelete;

  const GlobalCommentsTile({
    super.key,
  ...
  @override
  State<GlobalCommentsTile> createState() => _GlobalCommentsTileState();
}

class _GlobalCommentsTileState extends State<GlobalCommentsTile> {
